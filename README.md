...
# No more HM slaves!
HM Moves can be used without teaching the HM to a species.
...
(See assets/move_whitelists/ for files containing the lists of species that can use moves. Feedback is very welcome!)
